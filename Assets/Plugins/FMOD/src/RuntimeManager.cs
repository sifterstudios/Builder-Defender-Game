...
namespace FMODUnity
{
    ...
    public class RuntimeManager : MonoBehaviour
    {
        ...
        static FMOD.RESULT DEBUG_CALLBACK(FMOD.DEBUG_FLAGS flags, IntPtr filePtr, int line, IntPtr funcPtr,
            IntPtr messagePtr)
        {
        ...
        Dictionary<FMOD.GUID, FMOD.Studio.EventDescription> cachedDescriptions =
        ...
        static FMOD.RESULT ErrorCallback(IntPtr system, FMOD.SYSTEM_CALLBACK_TYPE type, IntPtr commanddata1,
 ...
 false, System.Action completionCallback = null)
        ...
        private static void SetListenerLocation3D(int listenerIndex, Transform transform, Rigidbody rigidBody = null,
            GameObject attenuationObject = null)
        {
        ...
        private static void SetListenerLocation2D(int listenerIndex, Transform transform, Rigidbody2D rigidBody = null,
            GameObject attenuationObject = null)
        {
            if (attenuationObject)
            {
