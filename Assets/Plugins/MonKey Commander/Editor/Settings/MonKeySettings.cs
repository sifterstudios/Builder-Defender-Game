...
public class MonKeySettings : Editor
{
    ...
    {
        EditorGUILayout.BeginHorizontal();
        EditorGUILayout.LabelField("Limit To Selected Assemblies");
        OnlyScanSpecified = EditorGUILayout.Toggle(OnlyScanSpecified);
        EditorGUILayout.EndHorizontal();
    ...
    private void CheckSearchOptions()
    {
        ...
        PutInvalidCommandAtEndOfSearch = EditorGUILayout.Toggle(PutInvalidCommandAtEndOfSearch);
        EditorGUILayout.EndHorizontal();
    }
    ...
    [HideInInspector] public bool OnlyScanSpecified = true;
